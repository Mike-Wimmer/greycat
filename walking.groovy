...
double stepOverHeight1=7.5;
	long stepOverTime1=150;// Servo loop times number of points times Nyquest doubeling
	Double zLock1=   7.5;
	Closure calcHome1 = { DHParameterKinematics leg -> 
	...
	boolean usePhysicsToMove1 = true;
	long stepCycleTime1 =600
	long walkingTimeout1 =stepCycleTime1*2
	int numStepCycleGroups1 = 2
	
	double standardHeadTailAngle1 = -20
	double staticPanOffset1 = 20
	double coriolisGain1 = 1.1
	boolean headStable1 = true
	double maxBodyDisplacementPerStep1 = 20
	double minBodyDisplacementPerStep1 = 30
	def args =  [stepOverHeight1,
	stepOverTime1,
	zLock1,
	calcHome1,
	usePhysicsToMove1,
	stepCycleTime1,
	numStepCycleGroups1,
	standardHeadTailAngle1,
	staticPanOffset1,
	coriolisGain1,
	headStable1,
	maxBodyDisplacementPerStep1,
	minBodyDisplacementPerStep1,
	walkingTimeout1]
...
return new com.neuronrobotics.sdk.addons.kinematics.IDriveEngine(){
	...
	void updateDynamics(IMUUpdate update){
		...
		double velocity=0
		if( Math.abs(update.getzAcceleration())>0 ){
			...
			velocity=0
		//println " IMU= "+velocity+ " "+update.getzAcceleration()
		if(incrementTime>10){
